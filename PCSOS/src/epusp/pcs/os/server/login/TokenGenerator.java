...
public class TokenGenerator {
    ...
    public String createToken(User user) {
        return createToken(user, new TokenOptions());
    }
    
    /**
     * Create a token for the given user and options.
     *
     * @param data
     * @param options
     * @return
     */
    public String createToken(User user, TokenOptions options) {
        if (user == null && (options == null || (!options.isAdmin() && !options.isDebug()))) {
