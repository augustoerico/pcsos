...
public class AgentTablePresenter implements Presenter{
	...
	public AgentTablePresenter(IAdminWorkspaceServiceAsync rpcService, AdminWorkspaceConstants constants, SharedResources resources, 
			int pageSize, SelectedRowHandler<Agent> handler){
	...
	public void go(HasWidgets container) {		
		...
		Column<Agent, ImageResource> agentActiveColumn = new Column<Agent, ImageResource>(new ImageResourceCell()) {
			@Override
			public ImageResource getValue(Agent object) {
				if(object.isActive())
		...
		table.addColumn(agentActiveColumn, constants.active());
