...
public class MotorcycleTablePresenter implements Presenter{
	...
	public MotorcycleTablePresenter(IAdminWorkspaceServiceAsync rpcService, AdminWorkspaceConstants constants, int pageSize, SelectedRowHandler<Motorcycle> handler){
